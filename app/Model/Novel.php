 ...
 * @property-read null|\Hyperf\Database\Model\Collection|NovelChapter[] $chapter 章节数
 */
class Novel extends Base
{
    ...
    public function chapter(){
        return $this->hasMany(NovelChapter::class,'novel_id', 'id');
    }
